...
const GDCACV13092010 = new person("Первый класс МЕЛИТОПОЛЬ MLE - НЬЮ-ЙОРК (Международный аэропорт имени Джона Кеннеди)  JFK", "Вячеслав", "Чуйко", "Николаевич", "24.11", "Мелитополь, УССР", "Дак Тур Эдженси", "2411HB", "23.11.2023", "Мы должны считать потерянным каждый день, в который мы не танцевали хотя бы раз. - Фридрих Ницше. С днем рождения!")
